<template>
  <div class="app-container">
    ...
    <div class="table-card">
      <el-table v-loading="loading" :data="achievementList">
        ...
        <el-table-column label="状态" align="center" width="80">
          <template><span class="status-tag status-2">待校审</span></template>
        </el-table-column>
    ...
    <!-- 审核弹窗 -->
    <el-dialog title="校级审核" :visible.sync="auditOpen" width="560px" append-to-body class="modern-dialog">
      <el-form ref="auditForm" :model="auditForm" :rules="auditRules" label-width="100px">
        ...
        <el-form-item label="审核结果" prop="auditResult">
          <el-radio-group v-model="auditForm.auditResult" class="audit-radio-group">
            <el-radio label="1">
              <span class="audit-option pass"><i class="el-icon-circle-check"></i> 通过（最终审核通过）</span>
            </el-radio>
            <el-radio label="2">
...
<script>
import { schoolAuditList, schoolAuditHandle, getAuditDetail } from "@/api/achievement/audit";
...
export default {
  ...
  data() {
    return {
      ...
      queryParams: { pageNum: 1, pageSize: 10, title: null, collegeId: null, category: null }
    };
  },
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      schoolAuditList(this.queryParams).then(response => {
